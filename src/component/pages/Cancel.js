      ...
      <div className="Order_Details_modal">
        ...
        <div className="p-3 space-y-4">
          ...
          {selectedReason === "Other" && (
            <div>
              <label className="text-xs text-white/40 uppercase tracking-widest mb-1 block">
                Reason likhо *
              </label>
              <textarea
                value={customReason}
                ...
                rows={3}
                className="w-full px-3 py-2 rounded-xl text-sm text-white placeholder-white/30 bg-white/10 border border-white/20 focus:outline-none focus:border-red-400/50 transition-all resize-none"
              />
            </div>
          )}
        </div>
        ...
        >
          <button
            onClick={handleClose}
            className="px-5 py-2.5 rounded-xl text-sm font-semibold text-white/60 hover:text-white transition"
