      ...
      >
        ...
        >
          ...
          >
            ...
            <Row label="INVOICE NO." value={billNo || orderId} />
            <Row label="TABLE NO." value={table_no || "Takeaway"} />
  
            <Divider />
  
            {/* Captain + Time */}
            <Row label="Captain Name" value={captain_name} />
            <Row label="Time" value={date_time} />
