...
//           color: open ? "#fff" : "#ffffff26",
//           boxShadow: open ? "0 0 8px #a7a7a780" : "none",
//         }}
//       >
//         {/* Three-dot icon */}
...
//         >
//           {/* Header */}
//           <div className="px-3 py-1.5 border-b border-white/10 text-white/40 text-xs uppercase tracking-widest">
//             {table.dg05_table_name}
//           </div>

//           <button
//             onClick={() => { onMove(table); setOpen(false); }}
//             className=""
//           >
...
//           <button
//             onClick={() => { onMerge(table); setOpen(false); }}
//             className=""
//           >
...
//           <button
//             onClick={() => { onSplit(table); setOpen(false); }}
//             className=""
//           >
...
//               className={`main_table_action_btn
//                 ${selectedTable?.dg05_table_id === t.dg05_table_id
//                   ? "gold_bg"
...
//             >
//               {/* ⬇️ 3-dot action button — top right, only on Busy tables */}
//               <ActionDropdown
//                 table={table}
  ...
  return (
    ...
    >
      <button
        ...
        className="w-6 h-6 flex items-center justify-center rounded-full transition-all duration-200"
        style={{
          background: open ? "#8a8a8a" : "#ffffff26",
          border: "1px solid #8080803b",
          color: open ? "#fff" : "#ffffff26",
          boxShadow: open ? "0 0 8px #a7a7a780" : "none",
        }}
